...
<li><a href='/'>  Home </a></li>
  ...
  return (
    ...
    <div className={`max-w-screen-2xl container mx-auto md:px:20 px-4 
      dark:bg-slate-900 dark:text-white fixed top-0 left-0 right-0 z-50 ${sticky? "sticky-navbar shadow-md bg-base-200 dark:text-white duration-300 transition-all ease-in-out":""}`} >
